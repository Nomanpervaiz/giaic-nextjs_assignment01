...
const Footer = () => {
  return (
    <footer className="text-white bg-black body-font  w-full">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-100">
        <Image className="h-12 w-12 border rounded-full bg-white" src={logohai} alt="Logo" />
          <span className="ml-3 text-xl">Achi see website</span>
        </a>
